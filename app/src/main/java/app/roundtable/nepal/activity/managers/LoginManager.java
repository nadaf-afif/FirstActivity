...
public class LoginManager extends Manager {
    ...
    public String updateProfile(String[] params) throws IOException {
        ...
        builder.addFormField("gender", params[4]);
        builder.addFormField("blood_group", params[5]);
        builder.addFormField("mobile", params[6]);
        builder.addFormField("spouse_name", params[7]);
        builder.addFormField("dob", params[8]);
        builder.addFormField("spouse_dob", params[9]);
        builder.addFormField("anniversary_date", params[10]);
        builder.addFormField("res_phone", params[11]);
        builder.addFormField("office_phone", params[12]);
        builder.addFormField("designation", params[13]);
        builder.addFormField("res_city", params[14]);
        builder.addFormField("office_city", params[15]);
        builder.addFormField("state", params[16]);
        builder.addFormField("company", params[17]);
        builder.addFormField("address", params[18]);
